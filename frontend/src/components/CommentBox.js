            ...
            <div id="reply_div_comments" className={reply_div_bar}>
                ...
                </div>
                {
                    ...
                    <div className="comment_foot">
                      <button onClick={handleReplyDisplay} style={{cursor:"pointer",display:"flex",padding:"0%",outline:"0",background:"none",border:"none"}}><h4>Replies({props.replies.length + child_reply.length })</h4></button>
